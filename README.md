...
Open dev tools (F12) on livelib site and get **llsid** cookie value on "application page". Set it to env variable **LIVELIB_COOKIE** in the .env file.<br>
Open dev tools on goodreads site and get **at-main** and **ubid-main** cookies values. Set them to env variables **GOODREADS_COOKIE_1** and **GOODREADS_COOKIE_2** in the .env file.<br>
